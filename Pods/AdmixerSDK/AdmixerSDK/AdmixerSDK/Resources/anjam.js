(function () {
    ...
    anjam.constructMessage = function (command, paramsList) {
        ...
        return AMJAM_PROTOCOL + command + "?" + params;
    }
    ...
    anjam.listener = function (event) {
        ...
        if (a.protocol === SDKJS_PROTOCOL) {
            anjam.anlog("AMJAM received: " + event.data);
    ...
    // Initial setup on first load on AMJAM.js
    anjam.setup = function () {
        ...
        anjam.anlog("AMJAM instance created: name(" + window.name +
